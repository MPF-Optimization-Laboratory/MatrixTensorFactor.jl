...
export combined_norm, dist_to_Ncone, nnmtf, rel_error, mean_rel_error, relative_error # Functions
...
export IMPLIMENTED_OPTIONS, IMPLIMENTED_NORMALIZATIONS, IMPLIMENTED_METRICS, IMPLIMENTED_PROJECTIONS, IMPLIMENTED_CRITERIA, IMPLIMENTED_STEPSIZES # implimented options
